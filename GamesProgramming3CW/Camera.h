...
public:
	...
	void SetParentTransform(Transform* transform) { _parentTransform = transform; }
	Transform* GetParentTransform() { return _parentTransform; }
	...
	void SetRotation(GLfloat newYaw, GLfloat newPitch) { yaw = newYaw, pitch = newPitch; }
	void RotateTo(vec3 target);
